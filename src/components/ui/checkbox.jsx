...
const Checkbox = React.forwardRef(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer h-5 w-5 shrink-0 rounded-md border border-gray-300 shadow-sm",
      ...
      "dark:border-gray-600 dark:ring-offset-gray-950 dark:data-[state=checked]:border-blue-500 dark:data-[state=checked]:bg-blue-500",
